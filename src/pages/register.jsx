  ...
  const handleSubmit = async (event) => {
    ...
    <div className='registerPage'>
        ...
        <div className='registerPageImage'>
         ...
         <img id = "registerPageImage" src={process.env.PUBLIC_URL + '/registerimage.png'} alt="Example" />
         <p id = "registerPageImageLine1">Welcome aboard my friend</p>
         <p id = "registerPageImageLine2">just a couple of clicks and we start</p>
        </div>
